...
# Return models?
def send_request(_type, endpoint, return_raw=False):
    ...
    if _type == 'GET':
        ...
        res = requests.post(url, headers=headers, verify=TLS_PATH)
...
def get_forwarding_history():
    return send_request('POST', 'v1/switch')['forwarding_events']
